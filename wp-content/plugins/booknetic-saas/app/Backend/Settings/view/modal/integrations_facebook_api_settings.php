...
<div id="booknetic_settings_area">
	...
	<div class="settings-light-portlet">
		<div class="ms-title">
			<?php echo bkntcsaas__('Facebook API / Continue with Facebook button')?>
		</div>
			...
			<form class="position-relative">
				...
				<div class="form-row enable_disable_row">
					...
					<div class="form-group col-md-2">
						...
						<label for="input_facebook_login_enable"><?php echo bkntcsaas__('Disabled')?></label>
					</div>
					<div class="form-group col-md-2">
						...
						<label for="input_facebook_login_disable"><?php echo bkntcsaas__('Enabled')?></label>
					</div>
				...
				<div id="integrations_facebook_api_settings_area">
					...
					<div class="form-row">
						<div class="form-group col-md-6">
							<label for="input_facebook_app_id"><?php echo bkntcsaas__('App ID')?>: <span class="required-star">*</span></label>
					...
					<div class="form-row">
						<div class="form-group col-md-6">
							<label for="input_facebook_app_secret"><?php echo bkntcsaas__('App Secret')?>: <span class="required-star">*</span></label>
