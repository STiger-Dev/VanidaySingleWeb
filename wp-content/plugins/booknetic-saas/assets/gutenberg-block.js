(function ( element, blocks, editor, components )
{
	...
	registerBlockType( 'booknetic/booking', {
		title: 'Booking Panel',
		icon: iconEl,
		category: 'booknetic',
	...
	registerBlockType( 'booknetic/cabinet', {
		...
		attributes:
			{
				shortCode: {
					type: 'string',
					default: '[booknetic-saas-forgot-password]'
				}
			},
