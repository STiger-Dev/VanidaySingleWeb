		...
		<div class="bordered-light-portlet">
			<div class="form-row">
				...
				<div class="col-md-3">
					...
					<div class="form-control-plaintext">
						<?php echo $parameters['info']->getAppointmentInfo()->duration >= 1440 ? Date::datee( $parameters['info']->getAppointmentInfo()->date ) : Date::dateTime( $parameters['info']->getAppointmentInfo()->date . ' ' . $parameters['info']->getAppointmentInfo()->start_time )?>
					</div>
				</div>
			</div>
		</div>
