					...
					<form id="booking_panel_settings_per_step" class="position-relative">
						...
						<div class="hidden" data-step="finish">
							...
							<div class="form-group col-md-12">
								...
								<input type="text" class="form-control" id="input_redirect_url_after_booking" value="<?php echo Helper::getOption('redirect_url_after_booking', '')?>" placeholder="<?php echo bkntc__('Default: Reload current page.')?>">
							</div>
